defmodule Greptimex.Greptime.V1.Value do
  @moduledoc false

  use Protobuf,
    full_name: "greptime.v1.Value",
  ...
  field :list_value, 40, type: Greptimex.Greptime.V1.ListValue, json_name: "listValue", oneof: 0

  field :struct_value, 41,
    type: Greptimex.Greptime.V1.StructValue,
    json_name: "structValue",
    oneof: 0

  field :json_value, 42, type: Greptimex.Greptime.V1.JsonValue, json_name: "jsonValue", oneof: 0
end
